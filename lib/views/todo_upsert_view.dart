...
class _UpsertTodoListState extends State<UpsertTodoList> {
  ...
  void initState() {
    ...
    _endDate?.text = DateFormat('yyyy-MM-dd')
        .format(widget.defaultItem.endDate ?? DateTime.now());
          ...
          children: <Widget>[
            ...
            TextField(
              ...
              decoration: const InputDecoration(
                  icon: Icon(Icons.calendar_today), labelText: "應完成日期"),
              readOnly: true,
              onTap: () async {
            ...
            ButtonBar(
              children: <Widget>[
                ...
                GradientButton(
                  ...
                  onPressed: () {
                    setState(() {
                      _validate = _title.value.text.isEmpty ||
                          _detail.value.text.isEmpty;
                    });
